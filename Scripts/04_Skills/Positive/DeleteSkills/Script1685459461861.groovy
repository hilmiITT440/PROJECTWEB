...
WebUI.click(findTestObject('Qualification_skills_delete/v1_delete_skills/Page_OrangeHRM/3d_delete'))

WebUI.delay(3)

WebUI.waitForElementClickable(findTestObject('Qualification_skills_delete/Page_OrangeHRM/button_delete_performing'), 3)
