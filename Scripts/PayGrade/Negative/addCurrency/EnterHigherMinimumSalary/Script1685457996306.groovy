...
WebUI.click(findTestObject('PayGrade/Currencies/Currencies_grade41/Page_OrangeHRM/div_CAD - Canadian Dollar'))

WebUI.setText(findTestObject('PayGrade/Currencies/Page_OrangeHRM/input_Minimum Salary_oxd-input oxd-input--focus'), '1000')

WebUI.setText(findTestObject('PayGrade/Currencies/Page_OrangeHRM/input_Maximum Salary_oxd-input oxd-input--focus'), '100')

WebUI.verifyElementPresent(findTestObject('PayGrade/Currencies/Currencies_grade41/Page_OrangeHRM/span_Should be higher than Minimum Salary_currency'), 
    0)
