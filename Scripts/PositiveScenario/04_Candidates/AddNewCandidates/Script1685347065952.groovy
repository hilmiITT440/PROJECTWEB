...
WebUI.setText(findTestObject('Candidate/Page_OrangeHRM/input_Email_oxd-input oxd-input--focus'), 'onepiece@gmail.com')
...
WebUI.click(findTestObject('Object Repository/Candidate/Page_OrangeHRM/span_Consent to keep data_oxd-checkbox-inpu_1b1ae2'))

WebUI.click(findTestObject('Object Repository/Candidate/Page_OrangeHRM/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Candidate/Page_OrangeHRM/div_SuccessSuccessfully Saved'), 0)
