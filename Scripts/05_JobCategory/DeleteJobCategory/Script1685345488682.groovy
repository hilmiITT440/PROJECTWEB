...
WebUI.click(findTestObject('DeleteMoreThanOne/Page_OrangeHRM/button_QA_delete'))

WebUI.click(findTestObject('DeleteJobTitle/Page_OrangeHRM/button_Yes, Delete'))

WebUI.verifyElementPresent(findTestObject('Category/Page_OrangeHRM/div_SuccessSuccessfully Deleted'), 0)
