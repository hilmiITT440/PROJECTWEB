...
WebUI.setText(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 'domDominic21')

WebUI.setEncryptedText(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/input_Password_oxd-input oxd-input--active'), '8SQVv/p9jVScEs4/2CZsLw==')

WebUI.verifyElementPresent(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/span_Your password must contain minimum 1 number'), 
    0)
