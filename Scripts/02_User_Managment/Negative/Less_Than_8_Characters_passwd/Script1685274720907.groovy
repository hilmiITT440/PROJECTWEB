...
WebUI.setEncryptedText(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/input_Password_oxd-input oxd-input--active'), 'RAIVpflpDOg=')

WebUI.verifyElementPresent(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/span_Should have at least 7 characters'), 0)
