...
WebUI.setText(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/input'), 'jojo')

WebUI.click(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/div_No Records Found'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('TS03_AddNewAccount/Page_OrangeHRM/span_Invalid_emp_name'), 0)
